...
public class Board extends JPanel
{
  ...
  // New colours
  static Color whitePC = new Color(0,0,10);
  static Color whiteRC = new Color(0,0,11);
  static Color whiteNC = new Color(0,0,12);
  static Color whiteBC = new Color(0,0,13);
  static Color whiteQC = new Color(0,0,14);
  static Color whiteKC = new Color(0,0,15);
  
  static Color blackPC = new Color(1,0,10);
  static Color blackRC = new Color(1,0,11);
  static Color blackNC = new Color(1,0,12);
  static Color blackBC = new Color(1,0,13);
  static Color blackQC = new Color(1,0,14);
  static Color blackKC = new Color(1,0,15);

 // Preset colours for pieces
  private static final Color[] COLOURS = 
    {whitePC, whiteRC, whiteNC, whiteBC, whiteQC, whiteKC,
    blackPC, blackRC, blackNC, blackBC, blackQC, blackKC};
  
  // String used to indicate each colour
  private static final String[] COLOUR_NAMES = 
  {"whiteP", "whiteR", "whiteN", "whiteB", "whiteQ", "whiteK", "blackP", "blackR", "blackN", "blackB", "blackQ", "blackK"};
  ...
  private void paintGrid(Graphics g)
  {
    for (int i = 0; i < this.grid.length; i++)
    {
      ...
      {    
        ...
        Image whiteP = Toolkit.getDefaultToolkit().getImage("whiteP.png");//I ADDED THIS
        Image whiteR = Toolkit.getDefaultToolkit().getImage("whiteR.png");//this TOOOOO
        Image whiteN = Toolkit.getDefaultToolkit().getImage("whiteN.png");
        Image whiteB = Toolkit.getDefaultToolkit().getImage("whiteB.png");
        Image whiteQ = Toolkit.getDefaultToolkit().getImage("whiteQ.png");
        Image whiteK = Toolkit.getDefaultToolkit().getImage("whiteK.png");
        Image blackP = Toolkit.getDefaultToolkit().getImage("blackP.png");//I ADDED THIS
        Image blackR = Toolkit.getDefaultToolkit().getImage("blackR.png");//this TOOOOO
        Image blackN = Toolkit.getDefaultToolkit().getImage("blackN.png");
        Image blackB = Toolkit.getDefaultToolkit().getImage("blackB.png");
        Image blackQ = Toolkit.getDefaultToolkit().getImage("blackQ.png");
        Image blackK = Toolkit.getDefaultToolkit().getImage("blackK.png");
        
        if (curColour != null) // Draw pegs if they exist
         {
            g.setColor(curColour);
            if(curColour.getRGB() == whitePC.getRGB()) 
            {             
               g.drawImage(whiteP, curX+deltaX/100000, curY+deltaY/10000,deltaX, deltaY,this);
            }
            
            if(curColour.getRGB() == whiteRC.getRGB()) 
            {
               g.drawImage(whiteR, curX+deltaX/100000, curY+deltaY/10000,deltaX, deltaY,this);
            }
           
            if(curColour.getRGB() == whiteNC.getRGB()) 
            {
               g.drawImage(whiteN, curX+deltaX/100000, curY+deltaY/10000,deltaX, deltaY,this);
            }
           
            if(curColour.getRGB() == whiteBC.getRGB()) 
            {
               g.drawImage(whiteB, curX+deltaX/100000, curY+deltaY/10000,deltaX, deltaY,this);
            }
          
            if(curColour.getRGB() == whiteQC.getRGB()) 
            {
               g.drawImage(whiteQ, curX+deltaX/100000, curY+deltaY/10000,deltaX, deltaY,this);
            }
          
            if(curColour.getRGB() == whiteKC.getRGB()) 
            {
               g.drawImage(whiteK, curX+deltaX/100000, curY+deltaY/10000,deltaX, deltaY,this);
            }
          
            if(curColour.getRGB() == blackPC.getRGB()) 
            {
               g.drawImage(blackP, curX+deltaX/100000, curY+deltaY/10000,deltaX, deltaY,this);
            }
            
            if(curColour.getRGB() == blackRC.getRGB()) 
            {
               g.drawImage(blackR, curX+deltaX/100000, curY+deltaY/10000,deltaX, deltaY,this);
            }
            
            if(curColour.getRGB() == blackNC.getRGB()) 
            {
               g.drawImage(blackN, curX+deltaX/100000, curY+deltaY/10000,deltaX, deltaY,this);
            }
            
            if(curColour.getRGB() == blackBC.getRGB()) 
            {
               g.drawImage(blackB, curX+deltaX/100000, curY+deltaY/10000,deltaX, deltaY,this);
            }
            
            if(curColour.getRGB() == blackQC.getRGB()) 
            {
               g.drawImage(blackQ, curX+deltaX/100000, curY+deltaY/10000,deltaX, deltaY,this);
            }
            
            if(curColour.getRGB() == blackKC.getRGB()) 
            {
               g.drawImage(blackK, curX+deltaX/100000, curY+deltaY/10000,deltaX, deltaY,this);
            }
        }
      }
    }
